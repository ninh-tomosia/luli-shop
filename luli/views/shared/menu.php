            ...
            <div class="row">
                <div class="col-sm-12 text-left menu-1">
                    <ul id="main-menu">
                        ...
                        ?>
                            <li class="cart"><a id="gio_hang" class="menu-item" href="./gio-hang.php"><i class="icon-shopping-cart"></i> giỏ hàng [<?php echo $count; ?>]</a></li>
                        <?php } else { ?>
                            <li class="cart"><a id="gio_hang" class="menu-item" href="./gio-hang.php"><i class="icon-shopping-cart"></i> giỏ hàng [0]</a></li>
                        <?php } ?>
                        <?php
