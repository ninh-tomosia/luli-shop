...
// include '../../db_connect.php';
    ...
    $sql = "SELECT * FROM baidang, sanpham, loaisanpham WHERE baidang.masp = sanpham.masp and sanpham.loaisanpham = loaisanpham.maloai and loaisanpham.madmsp = 3 and baidang.trangthai = 1";
