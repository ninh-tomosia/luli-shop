...
$sql = "SELECT * FROM baidang, sanpham, loaisanpham WHERE baidang.masp = sanpham.masp and sanpham.loaisanpham = loaisanpham.maloai and loaisanpham.madmsp = 2 and baidang.trangthai_db = 1";
