...
?>
    <div class="body">
        <div class="table-responsive">
            <a href="" style="float: right;">Thêm bài đăng</a>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_array($rs)) { ?>
                        <tr>
                            ...
                            <td style="width: 150px;"><a href="">Cập nhật</a> | <a href="./handlers/deleted_item.php?id=<?php echo $row['mabaidang']; ?>&tb=bd">Xóa</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
