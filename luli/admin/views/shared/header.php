...
<head>
    ...
    <link href="../../assets/admin/css/style_plus.css" rel="stylesheet">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/luli/admin/views/">LULI ADMIN</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    ...
                    </script> <a href="javascript:void(0);">LuLi Admin</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
