                    ...
                    <ul id="main-menu">
                        ...
                        <?php } else { ?>
                            <li class="cart has-dropdown">
                                <a id="login" class="menu-item" href="./views/thong-tin.php?id=<?php echo $_SESSION["userid"]; ?>" style="color: red;">
                                    <i class="icon-user2"></i> <?php echo $_SESSION["user"]; ?>
                                </a>
                                <ul class="dropdown custom-dropdown">
                                    <li><a href="./views/thong-tin.php?id=<?php echo $_SESSION["userid"]; ?>">Xem thông tin </a></li>
                                    <li><a href="./views/handlers/handle_logout.php?id=<?php echo $_SESSION["userid"]; ?>">Đăng xuất</a></li>
                                </ul>
                            </li>
                        <?php } ?>
                    </ul>
